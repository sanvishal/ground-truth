...
export const LEVEL2_MANUAL_PAGES: Readonly<Record<Level2ManualTopic, string>> = {
  specimen_record: "The surviving specimen requires continuous water and stable grow-light ignition. The transfer pod keypad remains mechanically accessible at all times.",
